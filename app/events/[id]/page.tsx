  ...
  const events = [
    ...
    },
    {
      ...
      rules: [
        ...
        "Any player who indulges in misconduct, which is use of sexism, racism, hate speech, targeted  harassment, or any other behavior discrimination, will be immediately disqualified from the tournament.",
        "Any player who displays excessive toxic behavior against tournament administrators will also get disqualified.",
      ],
      coordinators: [
        { name: "Sayan Maity", contact: "+91 85838 17241" },
      ],
    ...
    },
    {
      ...
      featured: false,
      rules: [
        "Players will have to play the game on their own device.",
        "If the game is found modded, the player will be disqualified.",
        "The player with the maximum coins and distance covered will be considered as the winner.",
      ],
      coordinators: [
        { name: "Sayan Maity", contact: "+91 85838 17241" },
      ],
